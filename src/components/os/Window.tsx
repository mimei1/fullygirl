...
import ChildWindowItem from './ChildWindow/ChildWindowItem'
import ChildWindowWrapper from './ChildWindow/ChildWindowWrapper'
        ...
        <div onMouseDown={onWindowInteract} style={styles.container}>
            ...
            >
                <div style={styles.windowBorderOuter}>
                    <div style={styles.windowBorderInner} ref={contentRef}>
                        <div
                        ...
                        {props.childrenWindow && props.childrenWindow.length
                            ? (
                                <ChildWindowWrapper ref={contentRef}>
                                    {props.childrenWindow.map((childWindowContent, i) => (
                                        <ChildWindowItem key={i}>
                                            {childWindowContent}
                                        </ChildWindowItem>
                                    ))}
                                </ChildWindowWrapper>
